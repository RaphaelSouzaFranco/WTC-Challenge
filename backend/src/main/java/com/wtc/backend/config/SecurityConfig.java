...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return email -> operatorRepository.findByEmail(email)
                .map(op -> User.withUsername(op.getEmail())
                        .password(op.getSenha()).roles("OPERATOR").build())
                .orElseThrow(() -> new UsernameNotFoundException("Operador não encontrado: " + email));
    }
